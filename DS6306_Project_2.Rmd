...
file_path <- "Case2PredictionsOwolabi Salary.csv"
...
#### GETTIONG THE SECOND VARIABLE
Next ill look for the optimumm variable to add to our classification model (Attrition ~ TotalWorkingYears) in order to provide the maximum auc score
```{r}
...
If I have more time, i plan to find the perfect classification model, based of finding the variables that maximisies the F1 metric, I believe that might improve specificity and sensitivity metric. Also I plan on looking at the best k value for our kNN model. And experimenrt further with oversampling and undersampling.
